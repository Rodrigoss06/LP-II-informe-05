...
namespace Transferencias
{
	...
	public partial class transferencias_yape : ContentPage
	{
		private Usuario usuario1;
        public StackLayout getHistorial { get { return Historial; } }
        public transferencias_yape (Usuario usuario)
		{
			InitializeComponent ();
            usuario1 = usuario;
        ...
        private void Yapear_Clicked(object sender, EventArgs e)
        {
            Navigation.PushModalAsync(new ModalYapear(this, usuario1));
        }
