...
namespace Transferencias
{
    ...
    public partial class ModalOtrasCuentas : ContentPage
    {
        private Usuario usuario_main;
        private int numero;
        private double monto;
        private Transferencia_bancaria _paginaTransferencias;
        public ModalOtrasCuentas(Transferencia_bancaria paginaTransferencias, Usuario usuario)
        {
            InitializeComponent();
        ...
        private void CuentaInicio_SelectedIndexChanged(object sender, EventArgs e)
        {
            Console.WriteLine("2132131");
        }

        private void CuentaFin_SelectedIndexChanged(object sender, EventArgs e)
        {
            Console.WriteLine("21321321");
        }
